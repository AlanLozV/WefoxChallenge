...
public class ShopingBagElements {
    ...
    public By productTitleDetails = By.cssSelector("h3[data-test='product-title']");
    ...
    public By productTotalDetails = By.cssSelector("div[class*='Pricingstyles__TotalRow']>span");
